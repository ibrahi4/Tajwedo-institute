export const siteConfig = {
  ...
  title: 'Tajwedo Institute - Online Quran, Arabic & Islamic Studies',
  ...
  social: {
    ...
    instagram: 'https://instagram.com/tajwedoinstitute',
    facebook: 'https://facebook.com/tajwedoinstitute',
    tiktok: 'https://tiktok.com/@tajwedoinstitute',
    telegram: 'https://t.me/TajwedoInstitute',
  },
  locales: ['en', 'ar'] as const,
  defaultLocale: 'en' as const,
  stats: { students: '500+', years: '10+', countries: '25+', rating: '4.9' },
};
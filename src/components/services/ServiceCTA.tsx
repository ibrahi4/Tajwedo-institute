...
export default function ServiceCTA({ slug }: Props) {
  const t = useTranslations(`serviceDetails.${slug}.serviceCta`);
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href={siteConfig.contact.whatsappLink} target="_blank" rel="noopener noreferrer">
              <Button variant="outline" className="border-2 border-white/30 text-white hover:bg-white/10 rounded-xl px-8 py-6 text-base font-semibold gap-2 bg-transparent">
